import { CURRENT_BOOK } from '@/lib/data'

export default function CurrentReadSection() {
  return (
    <section style={{ background: '#F7F4EF', padding: '100px 5vw' }} id="current-read">
      <div className="max-w">
        <span className="section-label reveal" style={{ color: '#8B5E0C' }}>
          Community Read
        </span>
        <h2 className="section-title dark reveal reveal-d1" style={{ marginBottom: '3rem' }}>
        ...
        <div className="reveal reveal-d2" style={{
          ...
          boxShadow: '0 0 0 1px rgba(250,204,21,0.06), 0 32px 64px rgba(0,0,0,0.5)',
        }} className="read-card">
          ...
          <div style={{ padding: '3rem', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <p style={{ fontSize: '0.95rem', color: '#6B7280', lineHeight: 1.7, marginBottom: '1.5rem' }}>
              Reading one chapter at a time. Growing one day at a time.
            </p>
            ...
            <div style={{ marginBottom: '2rem' }}>
              <div style={{
                ...
                <span style={{ fontSize: '0.7rem', color: '#6B7280' }}>Community Progress</span>
                <span style={{ fontSize: '0.7rem', color: '#6B7280' }}>
                  Chapter {CURRENT_BOOK.chapter} of {CURRENT_BOOK.totalChapters}
                </span>
              </div>
              <div style={{
                ...
                <div style={{
                  ...
                  background: '#FACC15', borderRadius: '2px',
                  transition: 'width 1s ease',
                }} />
              </div>
            </div>

            <a href="/current-read" className="btn-gold" style={{ width: 'fit-content' }}>
      ...
      <style>{`
        .read-card { grid-template-columns: 1fr 1.5fr !important; }
        @media (max-width: 640px) {
          .read-card { grid-template-columns: 1fr !important; }
          .read-card > div:first-child {
            padding: 2rem !important;
            flex-direction: row !important;
            gap: 1rem !important;
          }
          .read-card > div:first-child > div:first-child {
